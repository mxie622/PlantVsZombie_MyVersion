...
baobaoGroup = pygame.sprite.Group()
...
GEN_BAOBAO_EVENT = pygame.USEREVENT + 5
pygame.time.set_timer(GEN_BAOBAO_EVENT,6000)
...
def main():
    ...
    while running:
        ...
        for bullet in bulletGroup:
            ...
            for baobao in baobaoGroup:
                if pygame.sprite.collide_mask(bullet,baobao):
                    baobao.energy -= 1
                    bulletGroup.remove(bullet)
        ...
        for wallNut in wallNutGroup:
            ...
            for baobao in baobaoGroup:
                if pygame.sprite.collide_mask(wallNut, baobao):
                    baobao.isMeetWallNut = True
                    wallNut.baobaos.add(baobao)
        ...
        for peaShooter in peaShooterGroup:
            ...
            for baobao in baobaoGroup:
                if pygame.sprite.collide_mask(peaShooter, baobao):
                    baobao.isMeetWallNut = True
                    peaShooter.baobaos.add(baobao)
        ...
        for sunFlower in sunFlowerGroup:
            ...
            for baobao in baobaoGroup:
                if pygame.sprite.collide_mask(sunFlower, baobao):
                    baobao.isMeetWallNut = True
                    sunFlower.baobaos.add(baobao)
        ...
        baobaoGroup.update(index)
        baobaoGroup.draw(screen)
        ...
        for event in pygame.event.get():
            ...
            if event.type == GEN_BAOBAO_EVENT:
                baobao = Baobao()
                baobaoGroup.add(baobao)
